...
export class PkmnDTO {
  ...
  getTotalStats(): number {
    return (this.stats.hp + this.stats.attack + this.stats.defense + this.stats.spAttack + this.stats.spDefense + this.stats.speed);
  }
